...
For Android or Termux work, read [docs/android-termux.md](docs/android-termux.md)
before changing `codex-rs`. Keep source changes in this checkout and treat
externally supplied Android binaries, the proot wrapper, NDK stubs, and CI
artifacts as integration outputs. The documented target is
`aarch64-linux-android` / API 24; do not infer Android support from the normal
macOS, Linux, or Windows build instructions.
