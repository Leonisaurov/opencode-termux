...
CODEX_SRC="${CODEX_SRC:-$REPO_ROOT/codex}"
CODEX_TARGET_DIR="${CODEX_TARGET_DIR:-$WORK_DIR/codex-target}"
CODEX_OUT="${CODEX_OUT:-$REPO_ROOT/codex-android}"
CODEX_HOST_OUT="${CODEX_HOST_OUT:-$REPO_ROOT/codex-code-mode-host}"

incremental_exec codex \
    --input scripts/build-codex-android.sh --input scripts/env.sh \
