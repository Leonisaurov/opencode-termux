...
//   KILO_SRC            — checkout del fuente (default: build/kilocode-src-latest)
//   KILO_OUTFILE        — ruta del binario de salida (default: <repo>/kilo-android)
...
const dir = process.env.KILO_SRC
  ...
  : path.resolve(__dirname, "../build/kilocode-src-latest/packages/opencode")
...
await Bun.build({
  ...
  compile: {
    ...
    outfile: process.env.KILO_OUTFILE ?? path.resolve(__dirname, "../kilo-android"),
