        ...
        for (0..self.height) |uy| {
            ...
            for (0..self.width) |ux| {
                ...
                if (gp.isGraphemeChar(cell.char)) {
                    ...
                    // Degradamos a bytes vacíos (patrón de la ruta hermana ~1835). NO se
