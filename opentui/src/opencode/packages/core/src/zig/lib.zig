...
var gpa: std.heap.GeneralPurposeAllocator(.{
    .enable_memory_limit = gpa_safe_stats,
    .safety = gpa_safe_stats,
}) = .{};
...
export fn getBuildOptions(out_ptr: *ExternalBuildOptions) void {
    out_ptr.* = .{
        .gpa_safe_stats = gpa_safe_stats,
        .gpa_memory_limit_tracking = gpa_safe_stats,
    };
}
