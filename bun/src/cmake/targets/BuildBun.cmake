...
if(ANDROID)
  # WEBKIT_PATH is supplied by ci/scripts/env.sh and is absolute.  Do not
  # derive this prerequisite from CMAKE_SOURCE_DIR: the artifact lives in the
  # shared product build root, not inside the Bun checkout.
  set(PREBUILT_LIBTCC "${WEBKIT_PATH}/lib/libtcc.a")
